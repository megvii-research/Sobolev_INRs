...
class MLP(nn.Module):
    def __init__(self, in_features, w0, activations, out_features, hidden_features, num_hidden_layers, has_pos_encoding, length, fn_samples):
        super().__init__()
    ...
    def normalize_coordinate(self, coordinate, length):
        ...
        normalized_coordinate *= 200. # [-0.5 ~ 0.5] to [-100, 100]
